...
export default function MigrationArticlePage({ params }: { params: { id: string } }) {
  const theme = themes.find((t) => t.slug === 'migration');
  const article = recentContent.find((c) => c.id === params.id && c.theme === 'migration');
