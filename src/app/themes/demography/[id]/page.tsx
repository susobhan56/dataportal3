...
export default function DemographyArticlePage({ params }: { params: { id: string } }) {
  const theme = themes.find((t) => t.slug === 'demography');
  const article = recentContent.find((c) => c.id === params.id && c.theme === 'demography');
