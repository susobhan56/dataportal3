        ...
        <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex-1">
              <h1 className="text-3xl font-bold text-primary-700 mb-2">{factsheet.title}</h1>
            {/* Remove or replace the description if not present in Factsheet type */}
          ...
          <div className="mt-10">
            ...
            <FileViewer url={factsheet.pdf} type="pdf" />
          </div>
        </div>
      </section>
    </Layout>
